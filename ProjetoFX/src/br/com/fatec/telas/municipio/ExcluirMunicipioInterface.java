 ...
 * @author raife
 */
public class ExcluirMunicipioInterface extends Application{
    
    @Override
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("recicla.ExcluirMunicipioInterface.fxml"));
    ...
    private void handleExclude(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        Municipio entMun = new Municipio(codigo);
        ControllerMunicipio controllerMunicipio = new ControllerMunicipio();
        Boolean munSaida = controllerMunicipio.excluir(entMun);
